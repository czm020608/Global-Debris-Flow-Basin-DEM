...
- `Summary`: CRS, raster resolution, D8 scheme, trace gap, channel length/drop/slope, steepest and gentlest positions, drainage area.
...
- Confirm start/outlet/station points fall on or near the intended channel.
